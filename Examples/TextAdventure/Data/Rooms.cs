...
namespace TextAdventure.Data
{
	public static class Rooms
	{
		...
		#region Variables
		private static readonly RoomCollection _rooms = new RoomCollection();
		#endregion
...
There is a path to the north and path to the south.",
				...
				new RoomAction("Use Flashlight", gameState => gameState.ChangeRoom("pit1-lit"), gameState => gameState.StateValueExists("hallway1-visited") && (bool) gameState.GetStateValue("hallway1-visited"))
			));
