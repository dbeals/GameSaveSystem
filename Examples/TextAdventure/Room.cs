...
public sealed class Room
{
	...
	public Action<TextAdventureGameState> Entered { get; set; }
	...
	public Room(string key, string name, string description, Action<TextAdventureGameState> entered, params RoomAction[] actions)
	{
		Key = key;
		Name = name;
