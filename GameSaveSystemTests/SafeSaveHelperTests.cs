...
namespace GameSaveSystemTests
{
	...
	public class SafeSaveHelperTests
	{
		...
		{
			var result = SafeSaveHelper.GetBaseFileName("FileName.1.2.Extension");
		}
		...
		{
			var result = SafeSaveHelper.GetIncrementalFileName("FileName.1.2.Extension", 3);
		}
		...
		{
			var result = SafeSaveHelper.IncrementFileName("FileName.1.2.Extension", 3);
		}
		...
		{
			var result = SafeSaveHelper.IncrementFileName("FileName.One.Extension", 3);
		}
		...
		{
			var result = SafeSaveHelper.GetSearchPatternFromFileName("FileName.1.3.Extension");
		}
